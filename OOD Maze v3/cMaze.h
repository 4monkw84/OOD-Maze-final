...
protected:
	...
	// repeated looks for random endpoints that contain floor cells
	virtual bool    getRandomEmptyEndpoint(int& col, int& row, int nAttempts = 0);
	...
	cVector2    a_exit{ 0,0 };          // designated end/finish point
